...
export async function addComment(user_id, target_type, target_id, content) {
...
export async function getComments(target_type, target_id) {
  const result = await pool.query(
    `
    SELECT 
...
export async function deleteComment(id, user_id, role) {
  const query =
    role === "admin"
