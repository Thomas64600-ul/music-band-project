  ...
  return (
    ...
    >
      ...
      <div className="relative inline-block mb-10 text-center">
        <div className="absolute inset-0 bg-gradient-to-r from-transparent via-[var(--accent)]/20 to-transparent blur-md"></div>
      ...
      <div
        className="
          ...
          w-[45vw] h-[45vw]
          bg-[radial-gradient(circle_at_center,var(--accent)_10%,transparent_70%)]
