  ...
  return (
    <article
      className="
        ...
        hover:shadow-[0_0_25px_#FFD70040]
    ...
    >
      ...
      <div className="relative w-full h-52 sm:h-56 md:h-64 overflow-hidden group">
        ...
        <div
          className="
            absolute inset-0 bg-gradient-to-t from-[#0B0F17cc] via-[#00000055] to-transparent
        ...
        <div className="absolute top-3 left-3 bg-[#FFD700] text-black font-semibold text-xs px-3 py-1 rounded shadow-md">
          {date}
        </div>
      </div>
      ...
      >
        <h3
          className="
            ...
            mb-1 sm:group-hover:text-[#FFE55A] transition-colors
          "
        >
          {city}
        </h3>
